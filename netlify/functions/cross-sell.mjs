// ORACLE Cross-Sell Engine
// Netlify Function: /api/cross-sell
//
// After an ORACLE purchase, recommends relevant ecosystem platforms
...
export default async function handler(req, context) {
  ...
  try {
    ...
    const ECOSYSTEM_RECOMMENDATIONS = {
      'saas': [
        { platform: 'Grant OS', url: 'https://grant-os-platform.netlify.app', reason: 'Find SBIR/STTR grants for your SaaS innovation', priority: 1 },
      ...
      'healthtech': [
        ...
        { platform: 'Grant OS', url: 'https://grant-os-platform.netlify.app', reason: 'NIH and healthcare grants', priority: 2 },
      ...
      'fintech': [
        ...
        { platform: 'Grant OS', url: 'https://grant-os-platform.netlify.app', reason: 'FinTech innovation grants', priority: 3 },
      ],
      'cleantech': [
        { platform: 'Grant OS', url: 'https://grant-os-platform.netlify.app', reason: 'DOE and EPA clean energy grants', priority: 1 },
      ...
      'cpg': [
        ...
        { platform: 'Grant OS', url: 'https://grant-os-platform.netlify.app', reason: 'Small business grants', priority: 3 },
      ],
      'default': [
        { platform: 'Grant OS', url: 'https://grant-os-platform.netlify.app', reason: 'Find grants in your industry', priority: 1 },
        ...
        body: JSON.stringify({
          ...
          html: `
            <div style="font-family:system-ui,sans-serif;max-width:600px;margin:0 auto;color:#1a1a2e">
              <h2 style="color:#F59E0B">Your ORACLE Report is Ready</h2>
              ...
              ${recommendations.map((r, i) => `
                <div style="padding:16px;background:${i === 0 ? '#FEF3C7' : '#F9FAFB'};border-radius:8px;margin:12px 0">
                  ...
                  <a href="${r.url}?ref=oracle-crosssell&industry=${encodeURIComponent(industry || '')}" 
